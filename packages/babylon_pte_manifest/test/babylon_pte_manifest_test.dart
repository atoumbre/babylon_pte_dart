...
void main() {
  test('Test basic instructions', () {
    var manifest = ManifestBuilder()
        ...
        .publishPackage(Uint8List.fromList([1, 44, 3]))
        .build();

    expect(manifest.toString(), expected_manifest_1);
  });
  ...
  test('Test new account', () {
    ...
    expect(manifest.toString(), expected_manifest_2);
  });
}
